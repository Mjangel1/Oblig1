	...
	: mWindow(w)
{
   ...
   std::string filename = "C:\\Users\\marce\\source\\repos\\Oblig1_Task3\\Oblig1_Task3\\Task3Data.txt";

   //mObjects.push_back(new VkTriangle());
   mObjects.push_back((new VkTriangleSurface(filename)));
...
void RenderWindow::startNextFrame()
{
    ...
    // VkResult err = mDeviceFunctions->vkUnmapMemory(dev,mBufferMemory);
                                ...
                                VkBufferUsageFlags usage)
{
    ...
    qDebug() << "HERE!!!\n";
    qDebug() << visualObject->getVertices().size() << " " << sizeof(Vertex) << " " << visualObject->getVertices().size()*sizeof(Vertex) << "\n";
